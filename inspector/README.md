...
No JIT, StikDebug, or guest execution is required for Lab v1.
...
Lab v1 converts that into stable, comparable facts such as:
...
Those are future lab features; Lab v1 is intentionally a stable static-address
baseline.
